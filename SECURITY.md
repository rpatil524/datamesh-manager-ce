...
- Depending on risk and applicability, we act immediately or plan a fixed version within **30 days**, as described in our [vulnerability handling policy](https://docs.entropy-data.com/security/vulnerability-handling).
...
- [Vulnerability handling](https://docs.entropy-data.com/security/vulnerability-handling) — how we monitor and remediate CVEs
- [SBOM](https://docs.entropy-data.com/security/sbom) — a Software Bill of Materials is attached to every container image
